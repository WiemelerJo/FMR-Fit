...
class Fit(object):
    ...
    def __init__(self,  index_model, fit_num,Adata2,Bdata2, j_min,j):
        ...
        if fit_num == 1:
            def combine(B, alpha1, dB1, R1, A1):
                combi = dyson1(B, alpha1, dB1, R1, A1)
                return combi
        if fit_num == 2:
            def combine(B, alpha1, dB1, R1, A1, alpha2, dB2, R2, A2):
                combi = dyson1(B, alpha1, dB1, R1, A1) + dyson2(B, alpha2, dB2, R2, A2)
        if fit_num == 3:
            def combine(B, alpha1, dB1, R1, A1, alpha2, dB2, R2, A2, alpha3, dB3, R3, A3):
                combi = dyson1(B, alpha1, dB1, R1, A1) + dyson2(B, alpha2, dB2, R2, A2) + dyson3(B, alpha3, dB3, R3, A3)
                return combi
        if fit_num == 4:
            def combine(B, alpha1, dB1, R1, A1, alpha2, dB2, R2, A2, alpha3, dB3, R3, A3, alpha4, dB4, R4, A4):
                combi = dyson1(B, alpha1, dB1, R1, A1) + dyson2(B, alpha2, dB2, R2, A2) + dyson3(B, alpha3, dB3, R3, A3) + dyson4(B, alpha4, dB4, R4, A4)
                return combi
        if fit_num == 5:
            def combine(B, alpha1, dB1, R1, A1, alpha2, dB2, R2, A2, alpha3, dB3, R3, A3, alpha4, dB4, R4, A4, alpha5, dB5, R5, A5):
                ...
                return combi
        if fit_num == 6:
            def combine(B, alpha1, dB1, R1, A1, alpha2, dB2, R2, A2, alpha3, dB3, R3, A3, alpha4, dB4, R4, A4, alpha5, dB5, R5, A5 ,alpha6, dB6, R6, A6):
                ...
                return combi
        if fit_num == 7:
            def combine(B, alpha1, dB1, R1, A1, alpha2, dB2, R2, A2, alpha3, dB3, R3, A3, alpha4, dB4, R4, A4, alpha5, dB5, R5, A5 ,alpha6, dB6, R6, A6, alpha7, dB7, R7, A7):
                ...
                return combi
        if fit_num == 8:
            def combine(B, alpha1, dB1, R1, A1, alpha2, dB2, R2, A2, alpha3, dB3, R3, A3, alpha4, dB4, R4, A4, alpha5, dB5, R5, A5 ,alpha6, dB6, R6, A6, alpha7, dB7, R7, A7, alpha8, dB8, R8, A8):
                ...
                return combi
        if fit_num == 9:
            def combine(B, alpha1, dB1, R1, A1, alpha2, dB2, R2, A2, alpha3, dB3, R3, A3, alpha4, dB4, R4, A4, alpha5, dB5, R5, A5 ,alpha6, dB6, R6, A6, alpha7, dB7, R7, A7, alpha8, dB8, R8, A8, alpha9, dB9, R9, A9):
                ...
                return combi
        if fit_num == 10:
            def combine(B, alpha1, dB1, R1, A1, alpha2, dB2, R2, A2, alpha3, dB3, R3, A3, alpha4, dB4, R4, A4, alpha5, dB5, R5, A5 ,alpha6, dB6, R6, A6, alpha7, dB7, R7, A7, alpha8, dB8, R8, A8, alpha9, dB9, R9, A9, alpha10, dB10, R10, A10):
    ...
    def fit(self):
        result = model.fit(Adata2[j_min:j], params, B=Bdata2[j_min:j])
        return result
